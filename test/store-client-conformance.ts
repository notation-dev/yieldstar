...
export function storeClientConformanceCases(target: StoreClientTarget) {
...
export function wakeDeliveryConformanceCases(target: StoreClientTarget) {
...
export function sharedBackendConformanceCases(target: SharedStoreClientTarget) {
...
export function durableWakeConformanceCases(target: DurableStoreClientTarget) {
